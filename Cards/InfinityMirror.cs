...
namespace DanModCards.Cards
{
    public class InfinityMirror : CustomCard
    {
        ...
        protected override string GetDescription() =>
            "Every bullet you fire spawns 2 more bullets recursively. Secondary bullets deal half damage. Maximum bullet cap: 30.";
        ...
        {
            // Effect-driven card; no baseline stat changes.
        }
        ...
        {
            if (gun.gameObject.GetComponent<InfinityMirrorEffect>() == null)
            {
                gun.gameObject.AddComponent<InfinityMirrorEffect>();
            }
        }
